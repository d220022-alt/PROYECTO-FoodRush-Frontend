        ...
        <nav class="bg-white/95 backdrop-blur-sm shadow-sm py-3 md:py-4 sticky top-0 z-50">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4">
                ...
                <div class="flex items-center gap-4 md:gap-6">
                    ...
                    <button class="hover:text-bk-red transition relative text-xl text-gray-600 p-1" onclick="window.location.href='cart.html'">
                    ...
                    <a href="principal.html" class="hidden md:block ml-2"><span class="bg-bk-brown text-white px-5 py-2 rounded-full hover:bg-black transition-all shadow-md text-sm font-semibold">Home</span></a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <script>
        const app = {
            ...
            renderSidebar: function() {
                ...
                html += `<div class="pt-6 mt-4 border-t border-[#e6dac6]"><button onclick="app.resetFilters()" class="w-full py-2.5 text-xs font-bold text-red-500 border border-red-200 rounded-lg hover:bg-red-50 transition flex items-center justify-center gap-2"><i class="fa-solid fa-rotate-left"></i> Limpiar Filtros</button></div>`;
