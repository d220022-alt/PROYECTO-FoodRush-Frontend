        ...
        <nav class="bg-white/95 backdrop-blur-sm shadow-sm py-3 md:py-4 sticky top-0 z-50">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4">
                ...
                <div class="flex items-center gap-4 md:gap-6">
                    ...
                    <button class="hover:text-ph transition relative text-xl text-gray-600 p-1" onclick="window.location.href='cart.vue'">
                    ...
                    <a href="principal.vue" class="hidden md:block ml-2"><span class="bg-ph-black text-white px-5 py-2 rounded-full hover:bg-gray-800 transition-all shadow-md text-sm font-semibold">Home</span></a>
                </div>
            </div>
        </nav>
    </header>
