...
export const categoryModifiers = {
    ...
    Pizzas: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Pequena', 'Mediana', 'Familiar'], default: 'Mediana', priceOptions: { Pequena: -50, Mediana: 0, Familiar: 150 } },
        { id: 'crust', label: 'Orilla', type: 'choice', options: ['Clasica', 'Delgada', 'Rellena de queso'], default: 'Clasica', priceOptions: { 'Rellena de queso': 90 } },
        { id: 'extraCheese', label: 'Doble queso', type: 'toggle', price: 70 },
        { id: 'sauce', label: 'Salsa extra', type: 'counter', max: 3, price: 25 },
    ],
    Bebidas: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Regular', 'Grande', 'Venti'], default: 'Regular', priceOptions: { Grande: 40, Venti: 70 } },
        { id: 'ice', label: 'Hielo', type: 'choice', options: ['Sin hielo', 'Poco hielo', 'Regular', 'Extra hielo'], default: 'Regular', price: 0 },
        { id: 'milk', label: 'Leche', type: 'choice', options: ['Entera', 'Descremada', 'Almendra (+30)', 'Avena (+40)', 'Soya (+30)'], default: 'Entera', priceOptions: { 'Almendra (+30)': 30, 'Avena (+40)': 40, 'Soya (+30)': 30 } },
    ...
    Pollo: [
        ...
        { id: 'combo', label: 'Hacer combo (acompanante + refresco)', type: 'toggle', price: 160 },
    ...
    Postres: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Normal', 'Grande'], default: 'Normal', priceOptions: { Grande: 50 } },
    ...
    Pastas: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Individual', 'Para compartir'], default: 'Individual', priceOptions: { 'Para compartir': 180 } },
    ...
    Complementos: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Regular', 'Grande', 'Familiar'], default: 'Regular', priceOptions: { Grande: 40, Familiar: 90 } },
        { id: 'sauce', label: 'Dip o salsa', type: 'counter', max: 5, price: 25 },
    ],
    Combos: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Regular', 'Grande', 'Familiar'], default: 'Regular', priceOptions: { Grande: 50, Familiar: 110 } },
        { id: 'side', label: 'Acompanante', type: 'choice', options: ['Papas', 'Ensalada', 'Arroz'], default: 'Papas', price: 0 },
    ...
    Platos: [
        { id: 'side', label: 'Acompanante', type: 'choice', options: ['Papas', 'Ensalada', 'Vegetales'], default: 'Papas', price: 0 },
        ...
        { id: 'extra', label: 'Extra proteina', type: 'toggle', price: 90 },
    ],
    General: [
        { id: 'size', label: 'Tamano', type: 'choice', options: ['Normal', 'Agrandar'], default: 'Normal', priceOptions: { Agrandar: 60 } },
    ],
};
...
export const getModifiersForCategory = (category) => {
    ...
    if (
        includesAny(normalizedCat, ['carne de res', 'teriyaki beef', 'beijing beef', 'steak']) ||
