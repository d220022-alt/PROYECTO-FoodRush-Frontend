<!--
  ...
  Vista de Dominos Pizza. Agrupa pantalla, estado visual y acciones que ve el usuario en esa seccion.
...
const FRANCHISE_SLUG = 'dominos-pizza';
...
const buildModifiersForProduct = (product) => {
  ...
  const productUsesSweetOrDrinkModifiers = /(postre|helado|sundae|mcflurry|batida|dona|pastel|brownie|bebida|refresco|cola|jugo|cafe|te|frappe)/.test(productText);
