...
const makeOptions = (config) => [
  {
    key: "combo",
    label: config.comboLabel || "Hacer Combo",
    description: config.comboDescription || "Incluye acompañante y bebida",
    price: config.comboPrice ?? 150,
  },
  {
    key: "extra",
    label: config.extraLabel || "Extra ingrediente",
    description: config.extraDescription || "Personaliza tu orden",
    price: config.extraPrice ?? 35,
  },
  {
    key: "premium",
    label: config.premiumLabel || "Versión Premium",
    description: config.premiumDescription || "Mejor sabor y tamaño",
    price: config.premiumPrice ?? 50,
  },
  {
    key: "large",
    label: config.largeLabel || "Agrandar",
    description: config.largeDescription || "Tamaño más grande",
    price: config.largePrice ?? 45,
  },
];
...
export const franchiseConfigs = {
  ...
  kfc: {
    ...
    comboDescription: "Papas y refresco",
    comboPrice: 180,
    extraLabel: "Extra Crispy",
    extraPrice: 30,
    premiumLabel: "Agregar coleslaw",
    premiumPrice: 50,
    largeLabel: "Agrandar",
    largePrice: 60,
  },
  ...
  "little-caesars": {
    ...
    extraLabel: "Extra queso",
    extraPrice: 60,
    premiumLabel: "Masa especial",
    premiumPrice: 45,
    largeLabel: "Tamaño familiar",
    largePrice: 90,
  },
  "dominos-pizza": {
    slug: "dominos-pizza",
  ...
  "krispy-kreme": {
    ...
    extraPrice: 25,
    premiumLabel: "Relleno premium",
    premiumPrice: 40,
    largeLabel: "Caja de docena",
    largePrice: 110,
  },
  "helados-bon": {
    slug: "helados-bon",
    ...
    extraPrice: 20,
    premiumLabel: "Cono waffle",
    premiumPrice: 35,
    largeLabel: "Bola extra",
    largePrice: 40,
  },
  "barra-payan": {
    slug: "barra-payan",
  ...
  "rico-hot-dog": {
    ...
    extraPrice: 20,
    premiumLabel: "Doble salchicha",
    premiumPrice: 70,
    largeLabel: "Con queso",
    largePrice: 40,
  },
  chilis: {
    slug: "chilis",
    ...
    extraPrice: 40,
    premiumLabel: "Costillas extra",
    premiumPrice: 95,
    largeLabel: "Porción grande",
    largePrice: 60,
  },
  "panda-express": {
    slug: "panda-express",
...
Object.values(franchiseConfigs).forEach((config) => {
  config.options = makeOptions(config);
});
